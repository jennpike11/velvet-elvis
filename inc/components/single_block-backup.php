...
<section class="single-block__wrapper">
  ...
  <section class="ve-stage">
    ...
    <div class="ve-scene ve-scene--hula is-active" data-scene="0" data-scene-name="home">
      ...
      <img class="ve-scene__bug" src="https://www.velvetelvisstudios.com/wp-content/uploads/2026/05/bug.png" alt="">
      <img class="ve-scene__float ve-scene__float--hula" src="https://www.velvetelvisstudios.com/wp-content/uploads/2026/05/hula_girl.png" alt="">
    ...
    <div class="ve-scene ve-scene--volcano" data-scene="1" data-scene-name="about-us">
      ...
      <img class="ve-scene__float ve-scene__float--volcano" src="https://www.velvetelvisstudios.com/wp-content/uploads/2026/05/volcano.png" alt="">
      <img class="ve-scene__float ve-scene__float--volcano-flowers" src="https://www.velvetelvisstudios.com/wp-content/uploads/2026/05/flowers.png" alt="">
      <div class="ve-scene__copy">
        <h1>About us</h1>
    ...
    <div class="ve-scene ve-scene--players" data-scene="2" data-scene-name="contact">
      <div class="ve-scene__bg"></div>
      <div class="ve-scene__mid"></div>
      <img class="ve-scene__float ve-scene__float--palms" src="https://www.velvetelvisstudios.com/wp-content/uploads/2026/05/palm_trees_2.png" alt="">
      <img class="ve-scene__float ve-scene__float--players" src="https://www.velvetelvisstudios.com/wp-content/uploads/2026/05/players.png" alt="">
      <div class="ve-scene__copy">
        <h1>Contact Us</h1>
        <div class="ve-scene__description">
