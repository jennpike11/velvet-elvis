    ...
    <div class="ve-stage">
      ...
      <div class="ve-scene <?php echo esc_attr($sceneClass . $activeClass); ?>" data-scene="<?php echo esc_attr($scene_index); ?>" data-scene-name="<?php echo esc_attr($sectionName); ?>">
        ...
        <?php if ($scene_index === 0) : ?>
          <img class="ve-scene__bug" src="https://www.velvetelvisstudios.com/wp-content/uploads/2026/05/bug.png" alt="VelvetElvis Studios">
          <img class="ve-scene__float ve-scene__float--hula" src="https://www.velvetelvisstudios.com/wp-content/uploads/2026/05/hula_girl_1.png" alt="VelvetElvis Studios">
        <?php endif; ?>
        ...
        <?php if ($scene_index === 1) : ?>
          ...
          <img class="ve-scene__float ve-scene__float--volcano" src="https://www.velvetelvisstudios.com/wp-content/uploads/2026/05/volcano_1-1.png" alt="VelvetElvis Studios">
          <img class="ve-scene__float ve-scene__float--volcano-flowers" src="https://www.velvetelvisstudios.com/wp-content/uploads/2026/05/flowers.png" alt="VelvetElvis Studios">
        <?php endif; ?>

        <?php if ($scene_index === 2) : ?>
          <img class="ve-scene__float ve-scene__float--palms" src="https://www.velvetelvisstudios.com/wp-content/uploads/2026/05/palm_trees.png" alt="VelvetElvis Studios">
          <img class="ve-scene__float ve-scene__float--players" src="https://www.velvetelvisstudios.com/wp-content/uploads/2026/05/players_3.png" alt="VelvetElvis Studios">
        <?php endif; ?>
